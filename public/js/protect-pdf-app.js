// ProtectPdfApp v2.0 — shared browser-worker runtime adapter.
(function (G) {
  'use strict';
  var TAG='[ProtectPdfApp]', TOOL_ID='protect', _inFlight=false, _jobId=0, _cancelToken=null;
