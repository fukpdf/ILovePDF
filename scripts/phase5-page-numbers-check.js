...
if(!t)fail.push('registry missing'); else {
 if(t.slug!=='page-numbers'||t.execution!=='browser-worker'||t.capabilities?.lazyLoad!==true||t.capabilities?.streaming!=='adaptive-worker'||t.capabilities?.workerPool!==true||t.capabilities?.fileSizePolicy!=='unlimited')fail.push('registry capability contract');
}
...
console.log('PASS: Phase 5 Unit 11 Page Numbers gate — 16 contract checks');
