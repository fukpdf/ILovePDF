// SplitPdfApp v1.0 — Isolated Split PDF Tool (Phase 3 Full Isolation)
...
(function (G) {
  ...
  async function process(files, opts) {
    if (_inFlight) throw new Error('Split already in progress');
    ...
    var jobPromise = (async function () {
      ...
      onStep(0, 'done', 20);
      onStep(1, 'active', 25, 'Extracting pages\u2026');
