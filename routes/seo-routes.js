...
// Static guide blog posts that exist as public/blog/*.html (served at clean URLs)
const STATIC_BLOG_PATHS = [
  '/blog/merge-pdf-guide',
  '/blog/split-pdf-guide',
  '/blog/rotate-pdf-guide',
  '/blog/crop-pdf-guide',
  '/blog/organize-pdf-guide',
  '/blog/compress-pdf-guide',
  '/blog/pdf-to-word-guide',
  '/blog/pdf-to-powerpoint-guide',
  '/blog/pdf-to-excel-guide',
  '/blog/pdf-to-jpg-guide',
  '/blog/word-to-pdf-guide',
  '/blog/powerpoint-to-pdf-guide',
  '/blog/excel-to-pdf-guide',
  '/blog/jpg-to-pdf-guide',
  '/blog/html-to-pdf-guide',
  '/blog/edit-pdf-guide',
  '/blog/watermark-pdf-guide',
  '/blog/sign-pdf-guide',
  '/blog/add-page-numbers-guide',
  '/blog/redact-pdf-guide',
  '/blog/protect-pdf-guide',
  '/blog/unlock-pdf-guide',
  '/blog/repair-pdf-guide',
  '/blog/scan-pdf-guide',
  '/blog/ocr-pdf-guide',
  '/blog/compare-pdf-guide',
  '/blog/ai-summarizer-guide',
  '/blog/translate-pdf-guide',
  '/blog/workflow-builder-guide',
  '/blog/numbers-to-words-guide',
  '/blog/currency-converter-guide',
  '/blog/background-remover-guide',
  '/blog/crop-image-guide',
  '/blog/resize-image-guide',
  '/blog/image-filters-guide',
  '/blog/best-pdf-tools',
  '/blog/support-the-project',
];
...
router.get('/submit-urls', (_req, res) => {
  ...
  const urls  = [
    ...
    ...slugs.utilities.map(s => `${SITE}/${s}`),
    ...slugs.blogs.map(s => `${SITE}/blog/${s}`),
    `${SITE}/compare`,
